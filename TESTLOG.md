...
| P1.3 | Caddy contracts | `caddy-verify.sh` checks 1–5 (0001) + 6–9 (push: webhook 404 + upstream-never-hit, vapid-key 401/200, offline 200 text/html, deep 404 + forged 404) | to be run on VPS/CI with pinned `caddy:2.11.4-alpine@sha256:de23…` | `deploy/caddy-verify.sh` log (see CI `caddy-contract`) | ✅ CI caddy-contract green (reported 2026-09-22) |
